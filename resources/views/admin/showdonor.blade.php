      ...
      @include('admin.navbar')
        ...
        <table>
                            <tr style="background-color:#4F091D" align="center">
                                ...
                                <th style="padding:10px; font-size:15px; color:white">Age</th>
                                <th style="padding:10px; font-size:15px; color:white">Blood Group</th>
                ...
                <td>{{$donor->id}}</td>
                 ...
                 <td>{{$donor->contact}}</td>
                 <td><a onclick="return confirm('Are you sure to delete this')" class="btn btn-danger"href="{{url('deletedonor',$donor->id)}}">Delete</a></td>
                 <td><a class="btn btn-primary"href="{{url('updatedonor',$donor->id)}}">Update</a></td>
                </tr>
                @endforeach
